    ...
    <div class="page-container">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="text-muted mb-2">TOTAL APPROVED SELLERS</h6>
                        <h2 class="mb-0">{{ $total ?? 0 }}</h2>
                        <small class="text-success">
                            <i class="bi bi-check-circle"></i> Verified sellers
                        </small>
                    </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Approved Sellers List</h5>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-sm bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-2" style="width: 35px; height: 35px;">
                                ...
                                <td>
                                    @if(isset($seller['verifiedAt']))
                                        {{ \Carbon\Carbon::parse($seller['verifiedAt'])->format('d M Y') }}
                                    @else
                                        -
                                    @endif
                                </td>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary text-white">
                                            <h5 class="modal-title">
                                                <i class="bi bi-shop-window"></i> Detail Seller yang Telah Disetujui
                                            </h5>
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <p class="mb-0">
                                                                <span class="badge bg-success">{{ $seller['status'] ?? 'N/A' }}</span>
                                                            </p>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                            ...
                            <tr>
                                <td colspan="9" class="text-center py-4">
                                    ...
                                    <p class="text-muted">Belum ada seller yang disetujui</p>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
...
@push('scripts')
<script>
console.log('Approved Sellers data:', @json($sellers ?? []));
