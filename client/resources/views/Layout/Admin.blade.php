...
<head>
    <meta charset="utf-8" />
    <title>Detached Layout | Highdmin - Responsive Bootstrap 5 Admin Dashboard</title>
        ...
        <div class="sidenav-menu">
            ...
            <div data-simplebar>
                ...
                <ul class="side-nav">
                    ...
                    <li class="side-nav-item">
                        <a href="apps-tickets.html" class="side-nav-link">
            ...
            <div class="page-container topbar-menu">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <div class="topbar-item d-none d-md-flex">
                        ...
                        <div>
                            <h4 class="page-title fs-18 fw-bold mb-0">Detached</h4>
